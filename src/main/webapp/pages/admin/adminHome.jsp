                ...
                <div class="row mb-5">
                    <div class="col-sm">
                        <div class="card bg-secondary text-white mt-2">
                            ...
                            <div class="card-body" style="text-align:center;">
                                <h5 class="card-title">${no_of_books}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm">
                    ...
                    <div class="col-sm">
                        <div class="card bg-warning text-white mt-2">
                            <h5 class="card-header" style="text-align:center;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                     class="bi bi-tags-fill" viewBox="0 2 18 16">
                                    <path d="M2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2zm3.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
                                    <path d="M1.293 7.793A1 1 0 0 1 1 7.086V2a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l.043-.043-7.457-7.457z"/>
                                </svg> Total Categories
                            </h5>
                            <div class="card-body" style="text-align:center;">
                                <h5 class="card-title">${no_of_categories}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="card bg-danger text-white mt-2">
                            <h5 class="card-header" style="text-align:center;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                     class="bi bi-browser-safari" viewBox="0 0 18 16">
                                ...
                                </svg> Total Publishers
                            </h5>
                            <div class="card-body" style="text-align:center;">
                                <h5 class="card-title">${no_of_publishers}</h5>
                            </div>
                        </div>
                    </div>
                </div>
